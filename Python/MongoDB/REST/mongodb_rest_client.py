...
class MongoDB_REST_Client:
    ...
    def __verify_parameters(self, db_name: Optional[str], collection_name: Optional[str], id: Optional[ObjectId], is_id_required: bool, data: Optional[Any], is_data_required: bool) -> Optional[dict]:
        if db_name is None:
    ...
    def get(self, db_name: Optional[str], collection_name: Optional[str], id: Optional[ObjectId]) -> dict: 
        try:
    ...
    def put(self, db_name: Optional[str], collection_name: Optional[str], id: Optional[ObjectId], data: Optional[any]) -> dict: 
        try:
    ...
    def delete(self, db_name: Optional[str], collection_name: Optional[str], id: Optional[ObjectId]) -> dict: 
        try:
            error = self.__verify_parameters(db_name, collection_name, id, True, None, False)
            if error is not None:
                return error
